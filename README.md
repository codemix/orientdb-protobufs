...
Check out [the documentation](http://codemix.github.io/orientdb-protobufs/) or [orientdb.proto](./orientdb.proto) for the protocol definitions.
...
The documentation is generated by [docco](http://jashkenas.github.io/docco/) which depends on node.js, please ensure that [npm](http://npmjs.org/) is installed and working before continuing.

Then run `make docs`, which will produce a `docs` directory.
