 ...
 */
package com.orientechnologies.orientdb;
...
public class ONetworkProtocolBinaryProtobuf extends OBinaryNetworkProtocolAbstract {
  protected OClientConnection connection;
  protected OUser account;

  private String              dbType;

  public ONetworkProtocolBinaryProtobuf() {
    super("OrientDB <- BinaryClient/?");
  }

  public ONetworkProtocolBinaryProtobuf(final String iThreadName) {
    super(iThreadName);
  }
